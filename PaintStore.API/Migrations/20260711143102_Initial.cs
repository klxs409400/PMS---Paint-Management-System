    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaintsOrder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaintsOrder_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaintsOrder_PaintProducts_PaintProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaintsOrder_OrderId",
                table: "PaintsOrder",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PaintsOrder_PaintProductId",
                table: "PaintsOrder",
